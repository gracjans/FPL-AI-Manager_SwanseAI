...
def train_mlp_model(model: object, x_train: np.array, y_train: np.array, batch_size: int = 16, epochs: int = 30,
                    validation_split: float = 0.2, optimizer: str = 'adam', loss: str = 'mse', verbose: int = 1):
    """
